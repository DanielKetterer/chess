...
Date: 2026.08.11  |  Time control: daily (1/259200)  |  You played: white
...
- Lichess accuracy: you 95.6%, opponent 83.6%
...
- Your moves: 9 best, 16 excellent, 1 good, 0 inaccuracy, 4 mistake, 0 blunder
...
| 10 | -3.0 (piece) | sham | yes | mate | opening_ply |

![Evaluation graph](1012413288_20260819T122715Z_white.png)

## Biggest missed opportunity

You played 4.c3. Stockfish preferred O-O, after which the main line runs 4. O-O c6 5. d4 d5 6. exd5 cxd5. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine never settles on this move within the analysis depth, so how findable it was is not measured here; weigh this one lightly. Candidates considered by the engine: O-O (+1.63), d4 (+1.56), Nc3 (+1.49).

## Critical positions

- Ply 15 (you), 8.Nxg6: M2 -> +7.89 [forced mate was on the board]
- Ply 19 (you), 10.Qf3: M4 -> +8.34 [forced mate was on the board]
- Ply 49 (you), 25.b4: M9 -> +10.77 [forced mate was on the board]

## Your errors, move by move

| Move | Class | Category | WP loss | Refute depth | Seconds spent | Pre-error eval |
|---|---|---|---:|---|---:|---|
| 4.c3 | mistake | opening | 10% | 3 | 0 | balanced |
| 8.Nxg6 | mistake | allowed_tactic | 3% | 10 | 0 | winning |
| 10.Qf3 | mistake | opening | 2% | >18 | 22759 | winning |
| 25.b4 | mistake | positional | 0% | >18 | 1078 | winning |

### 4.c3 (mistake, positional, wp loss 10%)

You played 4.c3. Stockfish preferred O-O, after which the main line runs 4. O-O c6 5. d4 d5 6. exd5 cxd5. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine never settles on this move within the analysis depth, so how findable it was is not measured here; weigh this one lightly. Candidates considered by the engine: O-O (+1.63), d4 (+1.56), Nc3 (+1.49).

### 8.Nxg6 (mistake, positional, wp loss 3%)

You played 8.Nxg6. Stockfish preferred Bf7+, after which the main line runs 8. Bf7+ Ke7 9. Bg5#. There was a forced mate on the board and this move let it slip. Why it went wrong: the best move was a forcing check; motif: fork; creates threat on g6. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a quiet move, but one whose point shows at a glance. Candidates considered by the engine: Bf7+ (M2), Nxg6 (+7.59), Nf7 (+5.04).

### 10.Qf3 (mistake, positional, wp loss 2%)

You played 10.Qf3. Stockfish preferred Bf7+, after which the main line runs 10. Bf7+ Kxf7 11. Qd5+ Ke8 12. Qg8+ Bf8. There was a forced mate on the board and this move let it slip. Why it went wrong: the best move was a forcing check; motif: creates threat on h5. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine does not settle on this move until depth 17; reachable with real calculation, but not on a scan. Candidates considered by the engine: Bf7+ (M4), Qxh5 (+10.24), Rf1 (+9.67).

### 25.b4 (mistake, positional, wp loss 0%)

You played 25.b4. Stockfish preferred Re7, after which the main line runs 25. Re7 Ne4 26. a4 Nxc3 27. bxc3 b5. There was a forced mate on the board and this move let it slip. Why it went wrong: motif: creates threat on f5. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine never settles on this move within the analysis depth, so how findable it was is not measured here; weigh this one lightly. Candidates considered by the engine: Re7 (M9), Ne7 (M10), h4 (+12.41).
...
- Error categories: 1 allowed_tactic, 2 opening, 1 positional.
- Attention errors per 100 moves: 0.0.
- Pre-error eval buckets: 3 winning, 1 balanced, 0 losing.
- Opening: 3 error(s) (avg wp loss 5%).
