...
- Lichess accuracy: you 88.2%, opponent 74.5%
- Opening: B13 Caro-Kann Defense: Panov Attack (theory followed through ply 7)
- First deviation from theory: ply 8, Opponent played 4... Nf6
- Your moves: 7 best, 4 excellent, 6 good, 1 inaccuracy, 1 mistake, 0 blunder
...
|---|---|---|---|---|---|
| 7 | -8.0 (piece) | sham | yes | +1.0 pawns | opening_ply |
| 14 | -5.0 (piece) | sham | yes | +1.0 pawns | obvious |

![Evaluation graph](172291417954_20260730T142444Z_white.png)

## Biggest missed opportunity

You played 14.Re1. Stockfish preferred g4, after which the main line runs 14. g4 Bg6 15. Re1 Bd6 16. Nxg6 hxg6. Why it went wrong: left knight on e5 insufficiently defended; motif: creates threat on f5. Before committing to a quiet move here, the checklist is checks, captures, threats, in that order. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a forcing move, the kind a checks-and-captures scan catches. Candidates considered by the engine: g4 (+1.39), Ne2 (+0.04), f3 (-0.20).

## Critical positions

- Ply 33 (you), 17.Nxh8: +3.76 -> +3.82 [only-move situation]

## Your errors, move by move

| Move | Class | Category | WP loss | Refute depth | Seconds spent | Pre-error eval |
|---|---|---|---:|---|---:|---|
| 7.Qa4+ | inaccuracy | opening | 7% | 3 | 16 | balanced |
| 14.Re1 | mistake | missed_tactic | 14% | 3 | 14 | balanced |

### 7.Qa4+ (inaccuracy, positional, wp loss 7%)

You played 7.Qa4+. Stockfish preferred Qb3, after which the main line runs 7. Qb3 dxc4 8. Qxb7 Nbd7 9. Bxc4 Bd6. Why it went wrong: motif: creates threat on b7. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a quiet move, but one whose point shows at a glance. Candidates considered by the engine: Qb3 (+0.93), c5 (+0.55), Ne5 (+0.42).

### 14.Re1 (mistake, tactical, wp loss 14%)
...
- Middlegame: 1 error(s) (avg wp loss 14%).
