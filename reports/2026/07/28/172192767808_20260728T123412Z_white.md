...
- Lichess accuracy: you 76.3%, opponent 91.5%
- Opening: C55 Italian Game: Two Knights Defense, Modern Bishop's Opening (theory followed through ply 10)
- First deviation from theory: ply 11, You played 6. Nc3
- Your moves: 19 best, 15 excellent, 3 good, 2 inaccuracy, 1 mistake, 1 blunder
...
![Evaluation graph](172192767808_20260728T123412Z_white.png)

## Biggest missed opportunity

You played 27.Qc3. Stockfish preferred Qd2, after which the main line runs 27. Qd2 Qb6 28. b4 Rc8 29. c5 dxc5. The evaluation crossed from winning to losing, which matters more than the raw number. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a quiet move, but one whose point shows at a glance. Candidates considered by the engine: Qd2 (+2.82), b4 (-4.17), Qc3 (-5.14).

## Critical positions

- Ply 18 (opponent), 9...Nb8: +0.18 -> +3.11 [evaluation crossed equal -> losing]
- Ply 43 (you), 22.Rxe3: +3.95 -> +3.92 [only-move situation]
- Ply 53 (you), 27.Qc3: +2.82 -> -5.28 [only-move situation; evaluation crossed winning -> losing]
- Ply 54 (opponent), 27...Ne2+: -5.28 -> -5.58 [only-move situation]
- Ply 56 (opponent), 28...Nxc3: -5.93 -> -6.15 [only-move situation]
- Ply 72 (opponent), 36...Qxc5: -6.61 -> -6.60 [only-move situation]
- Ply 82 (opponent), 41...Qf4+: -M22 -> -81.68 [forced mate was on the board]

## Your errors, move by move

| Move | Class | Category | WP loss | Refute depth | Seconds spent | Pre-error eval |
|---|---|---|---:|---|---:|---|
| 8.Nd5 | inaccuracy | opening | 6% | 9 | 50 | balanced |
| 23.g4 | mistake | attention | 13% | 1 | 80 | winning |
| 26.Qd3 | inaccuracy | attention | 7% | 1 | 33 | winning |
| 27.Qc3 | blunder | attention | 61% | 2 | 133 | winning |

### 8.Nd5 (inaccuracy, positional, wp loss 6%)

You played 8.Nd5. Stockfish preferred a4, after which the main line runs 8. a4 Nd4 9. Bxd4 exd4 10. Nb1 c6. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine never settles on this move within the analysis depth, so how findable it was is not measured here; weigh this one lightly. Candidates considered by the engine: a4 (+0.45), h3 (+0.44), Bb3 (+0.29).

### 23.g4 (mistake, positional, wp loss 13%)

You played 23.g4. Stockfish preferred d4, after which the main line runs 23. d4 Ng6 24. b4 cxd4 25. Qxd4 O-O. Why it went wrong: motif: fork; creates threat on e5. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a quiet move, but one whose point shows at a glance. Candidates considered by the engine: d4 (+4.44), b4 (+4.13), Kh1 (+3.96).

### 26.Qd3 (inaccuracy, positional, wp loss 7%)

You played 26.Qd3. Stockfish preferred Qd2, after which the main line runs 26. Qd2 Rd8 27. b4 Qc7 28. Qd4 Kf8. This was a judgment error rather than a missed tactic; compare the pawn structure and piece activity after both moves. The engine prefers this move from at or below depth 6, which is as shallow as this measurement resolves; it sits near the surface, a quiet move, but one whose point shows at a glance. Candidates considered by the engine: Qd2 (+3.86), Qe1 (+3.07), Rc3 (+2.90).

### 27.Qc3 (blunder, positional, wp loss 61%)
...
- Error categories: 3 attention, 1 opening.
- Attention errors per 100 moves: 7.3.
- Pre-error eval buckets: 3 winning, 1 balanced, 0 losing.
- Opening: 1 error(s) (avg wp loss 6%).
- Middlegame: 3 error(s) (avg wp loss 27%).
